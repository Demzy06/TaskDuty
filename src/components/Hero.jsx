  ...
  return (
    <main className="container mt-5">
       <div className='row justify-content-between align-items-center'>
        ...
        <div className='col-sm-12 col-lg-6 fs-1 mission'>
          <h2 className='fs-1'>Manage your Task on <br/> <span style={{color: '#974fd0'}}>Task duty</span></h2>
          ...
          <div>
            ...
            <Link to='/AllTask'>
              <Button className="w-20 fs-4 to-tasks" variant="secondary">Go to My Task</Button>
            </Link>
          </div>
